...
function CheakoutPage() {
  ...
  const [checkDeliverable, setCheckDeliverable] = useState({
    cod: false,
    pre_paid: false,
  });
  ...
  const selectShippingRule = useRef({
    selectShippingRuleId: null,
    selectShippingFee: null,
  });
  ...
  const [ccavenuePayment, setCcavenuePayment] = useState(null);
    ...
    if (
      ...
      apiRequest
        ...
        .catch((err) => {
          ...
          setErrors({
            fName: fName.length === 0 ? "Please enter your first name" : "",
            lName: lName.length === 0 ? "Please enter your last name" : "",
            ...
            city: city === null ? "Please select your city" : "",
            pincode:
              pincode === null
                ...
                : "",
            address: address?.length === 0 ? "Please enter your address" : "",
          });
        });
    } else {
      setErrors({
  ...
  useEffect(() => {
    const { selectShippingFee } = selectShippingRule?.current;
    if (selectShippingFee) {
      setMainTotalPrice(totalPrice + parseInt(selectShippingFee));
    } else {
  ...
  const placeOrderHandler = async () => {
    // const { selectShippingRuleId } = selectShippingRule?.current;
    let selectShippingRuleId = 4;
    if (auth() && (checkDeliverable.cod || checkDeliverable.pre_paid)) {
      if (selectedBilling && selectedShipping) {
        // if (selectShippingRuleId < 0) {
        if (selectPayment) {
          if (selectPayment && selectPayment === "cashOnDelivery") {
              ...
              .cashOnDelivery(
                {
                  ...
                  shipping_method_id: parseInt(selectShippingRuleId),
                  // shipping_method_id: selectShippingRuleId,
            ...
            const url = `${process.env.NEXT_PUBLIC_BASE_URL}user/checkout/phonepe-order?shipping_method_id=${selectShippingRuleId}&shipping_address_id=${selectedShipping}&billing_address_id=${selectedBilling}`;
                ...
                <div className="container-x mx-auto">
                  <div className="w-full lg:flex lg:space-x-[30px] rtl:space-x-reverse">
                    <div className="lg:w-4/6 w-full">
                      <h1 className="sm:text-2xl text-xl text-white font-medium mt-5 mb-5">
                            ...
                            <form>
                              <div className="mb-6">
                                <div className="sm:flex sm:space-x-5 items-center">
                                  <div className="sm:w-1/2 w-full  mb-5 sm:mb-0 flex flex-col">
                                    <InputCom
                                    ...
                                    <>
                                      ...
                                      parseInt(totalPrice) ? (
                                        <div className="flex justify-between items-center">
                                          <div className="flex space-x-2.5 rtl:space-x-reverse items-center">
                                            <div className="input-radio">
                                              <input
                                                ...
                                                //     }
                                                ref={() => {
                                                  selectShippingRule.current.selectShippingRuleId =
                                                    rule.id;
                                                  selectShippingRule.current.selectShippingFee =
                                                    rule.shipping_fee;
                                                }}
                                                defaultChecked={rule.id}
                                                value={rule.id}
                                                type="radio"
                                                name="price"
                                              ...
                                              <svg
                                                ...
                                                height="24"
                                                viewBox="0 0 24 24"
                                                className="w-6 h-6 mr-2 text-green-500 rounded"
                                              >
                                                <path
                                                  fill="green"
                                                  d="M0 0h24v24H0z"
                                                />
                                                <path
                                                  d="M9 16.2l-3.8-3.8-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"
                                                  fill="white"
                                                />
                                              </svg>
                                            </div>
                                          ...
                                          <span
                                            suppressHydrationWarning
                                            className="text-[15px] text-normal text-white"
                                          >
                                            {currency_icon
                                              ? currency_icon +
                                                rule.shipping_fee
                        ...
                        <div className="mt-[30px] mb-5 relative">
                          <div className="w-full">
                            <div className="flex flex-col space-y-3">
                              {cashOnDeliveryStatus && checkDeliverable.cod && (
                                <div
                                  onClick={() =>
